package com.scrb.baselib.view.calendar;
...
//        mCurrentDayPaint.setColor(getResources().getColor(R.color.white));
...
//        mRadius=50;
    ...
    protected boolean onDrawSelected(Canvas canvas, Calendar calendar, int x, boolean hasScheme) {
        ...
        mCurDayTextPaint.setColor(getResources().getColor(R.color.gray_003));
        mSelectTextPaint.setColor(getResources().getColor(R.color.white)); //字体
        mSelectedPaint.setColor(getResources().getColor(R.color.theme)); //背景
        canvas.drawCircle(cx, cy-2, mRadius, mSelectedPaint);
        return true;
    }
    ...
    protected void onDrawText(Canvas canvas, Calendar calendar, int x, boolean hasScheme, boolean isSelected) {
        int cx = x + mItemWidth / 2;
        int cy = mItemHeight / 2;
        int top = -mItemHeight / 15;
//          9.10  1.44 10 1.3 10.10 1.7 11 1.55 11.10 1.95 12 1.8 12.10 2.0 1 1.85
//        if (calendar.isCurrentDay() && !isSelected) {
//            canvas.drawCircle(cx, cy-10, mRadius, mCurrentDayPaint);
//        }
        ...
        if (calendar.isWeekend() && calendar.isCurrentMonth()) {
            mCurMonthTextPaint.setColor(getResources().getColor(R.color.gray_003));
          /*  mCurMonthLunarTextPaint.setColor(0xFF489dff);*/
            mSchemeTextPaint.setColor(getResources().getColor(R.color.gray_003));
       /*     mSchemeLunarTextPaint.setColor(0xFF489dff);
            mOtherMonthLunarTextPaint.setColor(0xFF489dff);*/
            mOtherMonthTextPaint.setColor(getResources().getColor(R.color.gray_003));
        } else {
            mCurMonthTextPaint.setColor(getResources().getColor(R.color.gray_003));
