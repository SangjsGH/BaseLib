...
public class CustomMonthView extends MonthView {
    ...
    public CustomMonthView(Context context) {
        ...
        mCurrentDayPaint.setColor(getResources().getColor(R.color.theme));
    ...
    protected boolean onDrawSelected(Canvas canvas, Calendar calendar, int x, int y, boolean hasScheme) {
        ...
        mCurDayTextPaint.setColor(getResources().getColor(R.color.black));
        mSelectTextPaint.setColor(getResources().getColor(R.color.white));
        mSelectedPaint.setColor(getResources().getColor(R.color.theme));
    ...
    protected void onDrawText(Canvas canvas, Calendar calendar, int x, int y, boolean hasScheme, boolean isSelected) {
        ...
        if (calendar.isWeekend() && calendar.isCurrentMonth()) {
            mCurMonthTextPaint.setColor(getResources().getColor(R.color.gray_001));
           /* mCurMonthLunarTextPaint.setColor(0xFF489dff);*/
            mSchemeTextPaint.setColor(getResources().getColor(R.color.white));
           /* mSchemeLunarTextPaint.setColor(0xFF489dff);
            mOtherMonthLunarTextPaint.setColor(0xFF489dff);*/
            mOtherMonthTextPaint.setColor(getResources().getColor(R.color.white));
        } else {
