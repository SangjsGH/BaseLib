...
public class DefaultReUtil {
    private Retrofit retrofit;
    private static ApiService apiService;
    private static DefaultReUtil mInstance;
     ...
     * @return
     */
    public static DefaultReUtil getInstance() {
        if (mInstance == null) {
            synchronized (DefaultReUtil.class) {
                if (mInstance == null) {
                    mInstance = new DefaultReUtil();
                }
            }
        }
        return mInstance;
    ...
    public ApiService Api() {
        if (apiService == null)
            throw new IllegalStateException("需要在Splash的OnCreate中初始化");
        return apiService;
    }
